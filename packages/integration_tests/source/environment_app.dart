// End-to-end source for the `.environment<T>()` + `@SolidEnvironment`
// + dispose widget test. Mirrors the cross-class read shape (golden
// input `cross_class_value_read.dart`) extended with a FAB so the test
// can drive a tap, plus an empty `dispose()` stub on `Counter`
