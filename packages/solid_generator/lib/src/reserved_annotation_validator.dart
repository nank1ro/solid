...
/// contract is deferred to a later revision. No annotations are currently
/// reserved. This map is kept as a regression fence: any future reserved
/// annotation MUST be added here.
const Map<String, String> _reservedAnnotations = {};

/// Build-time guard: rejects any annotation listed in [_reservedAnnotations]
/// with a clear "not yet implemented" error. Currently a no-op since the map
/// is empty.
///
