...
// golden locks the rule that env fields are lazy and never spliced into
// `initState`, and that env fields never enter the host's dispose-name
// list — disposal belongs to the `Provider<T>` owner. The `@SolidState
// counter` field IS prepended to the existing dispose body, per the rule
// the host already follows for its own reactive members.
