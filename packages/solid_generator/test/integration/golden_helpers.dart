...
const List<String> goldenNames = <String>[
  ...
  'doc_comment_reference_preserved',
  'dispose_order',
  'text_arg_gets_value',
  'onpressed_untracked',
  'value_key_tracked',
  ...
  'environment_dispose_injected_transitive_base',
  ...
  'cross_file_constructor_param_type_only',
  'cross_file_constructor_injected_no_state',
  'cross_file_local_shadowing_decoy',
  'cross_file_import_hide_combinator',
  ...
  'cross_class_field_type_from_ctor_param',
  'cross_file_static_holder_read',
  'cross_file_super_param_bare_with_annotation',
  ...
  'foreign_signal_value_read',
  'foreign_signal_name_collision',
];
