#!/usr/bin/env bash
#
# Orchestrates pub.dev publishing for the solid monorepo.
#
...
#      the `publish.yml` workflow for that package,
...
#              creates triggers the downstream publish.yml workflow.
...
#   solid_annotations  -> (no in-repo deps)
#   solid_generator    -> solid_annotations
PACKAGES=(
  "solid_annotations:packages/solid_annotations"
  "solid_generator:packages/solid_generator"
)
